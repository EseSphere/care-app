    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ms-auto">
          ...
          <li class="nav-item">
            <a class="nav-link text-white fw-bold <?php if (basename($_SERVER['PHP_SELF']) == 'index.php') {
                                                    echo 'active';
                                                  } ?>" href="index.php">
          ...
          <li class="nav-item">
            <a class="nav-link text-white fw-bold <?php if (basename($_SERVER['PHP_SELF']) == 'contact.php') {
                                                    echo 'active';
                                                  } ?>" href="contact.php">
              <i class="bi bi-envelope"></i> Timesheet
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link text-white fw-bold <?php if (basename($_SERVER['PHP_SELF']) == 'logout.php') {
                                                    echo 'active';
                                                  } ?>" href="logout.php">
